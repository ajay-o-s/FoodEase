...
import { C as Me, f as Ut, h as U, k as Ft, l as zt } from "./aos.js";
...
function la() {
  ...
  const R = n.useMemo(
    ...
    q = (l, D = "info") => {
      ...
      g((L) => [
        ...L,
        { message: l, type: D, timestamp: _, id: Date.now() + Math.random() },
      ]);
    },
    G = (l, D = "success") => {
